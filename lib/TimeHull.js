...
class TimeHull {
  ...
  pointTrail(length, which) {
    ...
    let trail = this.points.slice(trailStart, trailEnd);
    if(typeof(which) != 'undefined') {
  ...
  //     return {
  //       name: 'Last Fixation',
  //       x: [this.points.slice(-1)[0].x],
  //       y: [this.points.slice(-1)[0].y],
  //       mode: 'markers',
  //       type: 'scatter',
  //       marker: {
  //         color: '#FFFFFF',
  ...
  // slicedPointsTime() {
  //   return this.slicedPoints.map(function(point) {
  //     return point.timestamp;
  //   });
  // }
  //
  // slicedPointsTimeText() {
  //   return this.slicedPoints.map(function(point) {
  //     return 'Time: ' + helpers.formatNumber(point.timestamp) + 'ms';
  //   });
  // }
