...
class TimeHullSeries {
  ...
  getAverageCentroidVelocity(opt) {
    ...
    if (typeof this.averageCentroidVelocity === 'undefined') {
      ...
      const hullTime = hulls[hulls.length - 1].endTime() - hulls[0].endTime();

      this.averageCentroidVelocityX = distanceX / hullTime;
      this.averageCentroidVelocityY = distanceY / hullTime;
      this.averageCentroidVelocity = distance / hullTime;
    }
